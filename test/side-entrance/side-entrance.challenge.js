...
describe('[Challenge] Side entrance', function () {
    ...
    it('Execution', async function () {
        ...
        const attacker = await (await ethers.getContractFactory('AttackSideEntranceLenderPool', player)).deploy(pool.address, player.address);
        await attacker.attack(ETHER_IN_POOL);
